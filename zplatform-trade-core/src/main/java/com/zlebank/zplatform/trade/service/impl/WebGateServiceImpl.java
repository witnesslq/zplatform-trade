...
public class WebGateServiceImpl extends BaseServiceImpl<TxnsOrderinfoModel, Long>implements IWebGateWayService{
    ...
    public void submitPay(TradeBean tradeBean) throws TradeException{
        ...
        ResultBean routResultBean = routeConfigService.getWapTransRout(DateUtil.getCurrentDateTime(), orderinfo.getOrderamt()+"",  StringUtil.isNotEmpty(tradeBean.getSubMerchId())?tradeBean.getSubMerchId():tradeBean.getMerchId(), txnsLog.getBusicode(), tradeBean.getCardNo());
