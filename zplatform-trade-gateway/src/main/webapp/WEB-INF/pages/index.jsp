						...
						<form method="post" action="/zplatform-trade/gateway/toFastPay.htm?txnseqno_=${txnseqno }" id="other_bank_form">
							...
							<c:if test="${busitype!='2000' }">					
								<div class="select-banklist per">信用卡
									<ul>
											<li>
												<input type="radio" name="bankCode" value="0102" id="CBC_radio" cardtype="2" />
												<label for="CBC_radio" class="bk icbc" title="中国工商银行"></label>
											</li>
											<li>
											<input type="radio" name="bankCode" value="0308" id="cmb001_radio" cardtype="2"/>
											<label id="cmb001" for="cmb001_radio" class="bk merchants" title="招商银行"></label>
											</li>
											 <li>
											<input type="radio" name="bankCode" value="0305" id="cmbc001_radio" cardtype="2"/>
											<label id="cmbc001" for="cmbc001_radio" class="bk minsheng" title="民生银行"></label>
											</li>
											<li>
											<input type="radio" name="bankCode" value="0302" id="hxb001_radio" cardtype="2"/>
											<label id="hxb001" for="hxb001_radio" class="bk china_citic" title="中信银行"></label>
											</li> 
	
											<li>
											<input type="radio" name="bankCode" value="0306" id="gdb_radio" cardtype="2"/>
											<label id="gdb001" for="gdb_radio" class="bk guangfa" title="广东发展银行"></label>
											</li>
											<li>
											<input type="radio" name="bankCode" value="0105" id="ecitic001_radio" cardtype="2"/>
											<label id="ecitic001" for="ecitic001_radio" class="bk construction" title="中国建设银行"></label>
											</li>
																											
										<li>
											<input type="radio" name="bankCode" value="0103" id="icbc001_radio" cardtype="2"/>
											<label id="icbc001" for="icbc001_radio" class="bk agricultural" title="中国农业银行"></label>
										</li>
										<li>
		                                  <input type="radio" name="bankCode" value="0303" id="ceb001_radio" cardtype="2"/>
		                                  <label id="ceb001" for="ceb001_radio" class="bk everbright" title="光大银行"></label>
		                              	</li>
			                              <li>
			                                  <input type="radio" name="bankCode" value="0309" id="cib001_radio" cardtype="2"/>
			                                  <label id="cib001" for="cib001_radio" class="bk industrial" title="兴业银行"></label>
			                              </li>
										<li>
											<input type="radio" name="bankCode" value="0104" id="BC_radio" cardtype="2"/>
											<label id="BC" for="BC_radio" class="bk china" title="中国银行"></label>
										</li>
										<li>
											<input type="radio" name="bankCode" value="0301" id="ABC_radio" cardtype="2"/>
											<label id="ABC" for="ABC_radio" class="bk communications" title="交通银行"></label>
										</li>
										<li>
											<input type="radio" name="bankCode" value="0304" id="comm001_radio" cardtype="2"/>
											<label id="comm001" for="comm001_radio" class="bk huaxia" title="华夏银行"></label>
										</li> 
										<li>
											<input type="radio" name="bankCode" value="0410" id="pingan_radio" cardtype="2"/>
											<label id="PINGAN" for="pingan_radio" class="bk pingan" title="平安银行"></label>
										</li>
										 <li>
			                                  <input type="radio" name="bankCode" value="0310" id="spdb001_radio" cardtype="2"/>
			                                  <label id="spdb001" for="spdb001_radio" class="bk spd" title="浦东发展银行"></label>
			                              </li>
			                              
			                              
			                              <li>
			                                  <input type="radio" name="bankCode" value="0403" id="bccb001_radio" cardtype="2"/>
			                                  <label id="bccb001" for="bccb001_radio" class="bk bjb" title="北京银行"></label>
			                              </li>
			                              <li>
			                                 <input type="radio" name="bankCode" value="0100" id="post" cardtype="2"/>
