...
import com.zlebank.zplatform.wechat.qr.job.RefundJob;
...
public class TestQqWechat {
    ...
    public void init(){
        ...
        refundJob = (RefundJob) context.getBean("refundRqJob");
     //   weChatRefundTrade = (IRefundTrade) context.getBean("weChatRefundTrade");
        weChatService = (WeChatQRService) context.getBean("weChatQRService");
    ...
    public void createOrder(){
    	try {
    		JSONObject json=	weChatService.creatOrder("160809002700054999");
    		System.out.println("生成订单结果"+json);
		} catch (Exception e) {
			e.printStackTrace();
		}
    ...
    */}
    ...
    public void testQueryWechatOrder(){
    	TradeBean tradeBean= new TradeBean();
		tradeBean.setTxnseqno("1608129900056319");
