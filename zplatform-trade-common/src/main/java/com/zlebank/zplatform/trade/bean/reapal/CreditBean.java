...
public class CreditBean {
     ...
     * @param sign
     */
    public CreditBean(String merchant_id, String card_no, String owner,
            String cert_type, String cert_no, String phone, String cvv2,
            String validthru, String order_no, String transtime,
            String currency, String total_fee, String title, String body,
            String member_id, String terminal_type, String terminal_info,
            String member_ip, String seller_email, String notify_url,
            String token_id, String version, String sign_type, String sign) {
        super();
        this.merchant_id = merchant_id;
        this.card_no = card_no;
        this.owner = owner;
