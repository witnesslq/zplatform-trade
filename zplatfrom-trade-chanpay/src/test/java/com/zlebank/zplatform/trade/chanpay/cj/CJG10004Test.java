 ...
 * @author guojia
 * @version
 * @date 2016年5月19日 下午5:35:11
 * @since 
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration("/*.xml")

public class CJG10004Test {
	...
	public String buildCjmsg(G10003Bean data) {
		...
		infoEl.addElement("TRX_CODE").setText(Cj.XMLMSG_TRANS_CODE_批量付款);
		...
		LOG.info("产生G10004批量收款：" + U.substringByByte(xml, 512));
		return xml;
	}//method
