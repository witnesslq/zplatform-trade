...
<div class="g-row">
 <div class="wrapper">
		 <ul class="flow-steps">
			<li><b  class="f"></b><a href="<%=basePath %>merch/withdraw.htm?txnseqno=${trade.txnseqno}">1.返回收银台</a><s></s></li>
...
<div class="mod_box">
		...
		<div class="txtC">
		        ...
		        <div style="text-align: center;text-decoration: overline;">
									<input type="button" class="btn btn_on" id="btn_Return" value="返回收银台"></input>
									<input type="button" class="btn btn_on" value="离开收银台" onclick="window.close()"/>
								</div>
				</div>
		<!--/提示 --> 
		</div>
