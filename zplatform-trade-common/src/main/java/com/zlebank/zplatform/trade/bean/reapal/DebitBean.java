...
public class DebitBean {
     ...
     * @param sign
     */
    public DebitBean(String merchant_id, String card_no, String owner,
            String cert_type, String cert_no, String phone, String order_no,
            String transtime, String currency, String total_fee, String title,
            String body, String member_id, String terminal_type,
