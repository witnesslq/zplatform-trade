...
<ul class="mod_list mt15">
			...
			<form method="post" action="/zplatform-trade/gateway/toPay.htm?txnseqno_=${trade.txnseqno}" id="form1" class="">
...
<div class="footer">
	<p class="foot_nav"><a href="/website/help/index.htm" style=""  target="_blank">关于我们</a> | <a href="/website/help/service.htm" target="_blank">隐私条款</a> | <a href="/website/help/mer.htm" target="_blank">合作加盟</a> | <a href="/website/help/reg.htm" target="_blank">会员服务</a></p>
