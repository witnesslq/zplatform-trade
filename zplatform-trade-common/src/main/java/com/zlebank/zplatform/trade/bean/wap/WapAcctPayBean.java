 ...
 * @author guojia
 * @version
 * @date 2015年10月13日 下午7:29:59
 * @since
 */
public class WapAcctPayBean implements Serializable {
    
    /**
     * serialVersionUID
     */
    private static final long serialVersionUID = -1986788398483702223L;
    ...
    /**
     * @return the paypassWd
     */
    public String getPaypassWd() {
        return paypassWd;
    }
    /**
     * @param paypassWd the paypassWd to set
     */
