...
import com.zlebank.zplatform.trade.cmbc.bean.RealTimeSelfWithholdingResultBean;
 ...
 * @since 
 */
public class WithholdingSelfReciveProcessor implements ReceiveProcessor{
    private static final String ENCODING = "UTF-8";
    private static final Log log = LogFactory.getLog(WithholdingSelfReciveProcessor.class);
        ...
        try {
            ...
            switch (msgType) {
                case REQUEST_WITHHOLDING_SELF:
                    ...
                    RealTimeSelfWithholdingResultBean realTimeWithholdingResultBean =  (RealTimeSelfWithholdingResultBean) xstream.fromXML(msg);
                    ...
                    if(verifyFlag){
                        //更新交易流水
                        TxnsWithholdingModel withholding = txnsWithholdingService.getWithholdingBySerialNo(realTimeWithholdingResultBean.getTranId());
                        if(withholding!=null){
                            withholding.setExectype(realTimeWithholdingResultBean.getRespType());
                            withholding.setExeccode(realTimeWithholdingResultBean.getRespCode());
                            withholding.setExecmsg(realTimeWithholdingResultBean.getRespMsg());
                            withholding.setSerialno(realTimeWithholdingResultBean.getTranId());
                            withholding.setPayserialno(realTimeWithholdingResultBean.getBankTranId());
                            withholding.setBanktrandate(realTimeWithholdingResultBean.getBankTranDate());
                            withholding.setBanktrantime(realTimeWithholdingResultBean.getBankTranTime());
                            withholding.setChargefee(Long.valueOf(realTimeWithholdingResultBean.getChargeFee()));
    ...
    public WithholdingSelfReciveProcessor() {
