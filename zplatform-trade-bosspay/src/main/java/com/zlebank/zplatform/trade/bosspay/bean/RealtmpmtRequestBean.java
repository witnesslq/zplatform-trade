 ...
 * @author guojia
 * @version
 * @date 2016年4月21日 上午11:38:16
 * @since
 */
public class RealtmpmtRequestBean {
	...
	private String usageType;// 用途 
	@JSONField(name="REMARK")
	private String remark;// 附言 
	@JSONField(name="USER_ID")
	private String userId;// 用户 id 
	@JSONField(name="USER_KEY")
	private String userKey;// 用户 key 
	/**
	 ...
	 * @param userKey
	 */
	public RealtmpmtRequestBean(String accountId, String agreementId,
			String bankAccount, String bankAccountName, String bankNumber,
			String bankName, String bankProvince, String bankCity,
			String amount, String usageType, String remark, String userId,
			String userKey) {
		super();
		this.accountId = accountId;
		this.agreementId = agreementId;
